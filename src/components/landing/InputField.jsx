...
export default function InputField() {
  return (
    <div className="w-full h-full bg-light py-24">
      <Container>
        ...
        className='absolute -top-12 left-0 w-16 lg:w-auto' />
          <div className='py-4 px-2 w-[290px] md:w-[450px] flex flex-col items-center justify-center gap-2 md:gap-4  '>
            ...
            <Input />
            <img src="/assets/book_stack_2.svg" alt="book_2" className='absolute -bottom-5  w-24 left-16 lg:w-auto lg:-bottom-10 lg:left-24 hidden md:block' />
          </div>
